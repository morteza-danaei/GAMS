...
userSchema.pre("save", function (done) {
    return __awaiter(this, void 0, void 0, function () {
        var saltRounds, password_1, hashedPassword_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!this.isModified("password")) return [3 /*break*/, 2];
                    saltRounds = 10;
                    password_1 = this.get("password");
                    return [4 /*yield*/, bcrypt_1.default.genSalt(saltRounds, function (err, salt) {
                            bcrypt_1.default.hash(password_1, salt, function (err, hash) {
                                hashedPassword_1 = hash;
                            });
                        })];
                case 1:
                    _a.sent();
                    // Store hash in your password DB.
                    this.set("password", hashedPassword_1);
                    _a.label = 2;
                case 2:
                    done();
                    return [2 /*return*/];
 ...
 */
userSchema.statics.build = function (props) {
